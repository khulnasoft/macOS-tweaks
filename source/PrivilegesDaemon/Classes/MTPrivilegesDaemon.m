    ...
    if (listener == _listener && newConnection != nil) {
        ...
        if (signingAuth) {
            ...
            NSString *reqString = [MTCodeSigning codeSigningRequirementsWithCommonName:signingAuth
                                                                      bundleIdentifier:@"com.khulnasoft.privileges.agent" 
             ...
             completionHandler:(void(^)(BOOL success))completionHandler
{
    ...
    if (userName) {
        ...
        if (success) {
            ...
            NSString *logMessage = [NSString stringWithFormat:@"KHULNASOFTLtd: User %@ now has administrator privileges", userName];
            ...
            NSString *logMessage = [NSString stringWithFormat:@"KHULNASOFTLtd: Failed to change privileges for user %@", userName];
                ...
                completionHandler:(void(^)(BOOL success))completionHandler
{
    ...
    if (userName) {
        ...
        if (success) {
            ...
            // log the privilege change
            NSString *logMessage = [NSString stringWithFormat:@"KHULNASOFTLtd: User %@ now has standard user privileges", userName];
