    ...
    if (!_listenerEndpoint) {
        ...
        [self connectToXPCServiceWithRemoteObjectProxyReply:^(id remoteObjectProxy, NSError *error) {
            ...
            if (error) {
                ...
                os_log_with_type(OS_LOG_DEFAULT, OS_LOG_TYPE_FAULT, "KHULNASOFTLtd: Failed to connect to XPC Service: %{public}@", error);
...
#pragma clang diagnostic ignored "-Warc-retain-cycles"
        [_xpcServiceConnection setInvalidationHandler:^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                os_log(OS_LOG_DEFAULT, "KHULNASOFTLtd: XPC Service connection invalidated");
            });
        }];
        ...
        [_xpcServiceConnection setInterruptionHandler:^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                self.listenerEndpoint = nil;
                self.xpcServiceConnection = nil;
                os_log(OS_LOG_DEFAULT, "KHULNASOFTLtd: XPC Service connection interrupted");
            });
        }];
...
#pragma clang diagnostic ignored "-Warc-retain-cycles"
        [_connection setInvalidationHandler:^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                os_log(OS_LOG_DEFAULT, "KHULNASOFTLtd: Agent connection invalidated");
        ...
        [_connection setInterruptionHandler:^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                os_log(OS_LOG_DEFAULT, "KHULNASOFTLtd: Agent connection interrupted");
                self->_connection = nil;
            });
        }];
#pragma clang diagnostic pop
...
#pragma clang diagnostic pop
        ...
        _remoteObjectProxy = [_connection remoteObjectProxyWithErrorHandler:^(NSError *error) {
            ...
            os_log_with_type(OS_LOG_DEFAULT, OS_LOG_TYPE_FAULT, "KHULNASOFTLtd: Failed to connect to agent: %{public}@", error);
